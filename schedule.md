...
| #3: Feb 1-5       | Software Architecture<br />REST                           			      |          | **[HW1 Due]({{ site.baseurl }}{% link assignments/hw1.md %})**<br />[HW2 Out](({{ site.baseurl }}{% link assignments/hw1.md %})), Team Formation Out    |
